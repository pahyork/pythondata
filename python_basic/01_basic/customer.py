...
# - 출생년도(birthyear) : 4자리로 입력, 숫자로 입력해야 함
...
from regex import W
custlist = [{'name': '홍길동', 'gender': 'F', 'email': 'asdfg@gmail.com', 'birthyear': '2000'}, 
            {'name': '홍길순', 'gender': 'M', 'email': 'qwert@gmail.com', 'birthyear': '2000'},
            {'name': '박효진', 'gender': 'F', 'email': 'ghjkl@gmail.com', 'birthyear': '2000'}]
# custlist = []
page = len(custlist) - 1
...
while True:
    ...
    if choice=="I":  
        ...
        if page <= 0:
            print(f'첫 페이지입니다 이전 페이지 이동 불가합니다')
        else:
            page -= 1
            print(f'현재 페이지는 {page+1}페이지입니다')
            print(custlist[page])
        ...
        if page >= len(custlist) - 1:
            print('마지막 페이지입니다 다음 페이지 이동 불가합니다')
        else:
            page += 1
            print(f'현재 페이지는 {page+1}페이지입니다')
            print(custlist[page])
